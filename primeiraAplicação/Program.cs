...
//List<string> listaDasBandas = new List<string> {"Legião Urbana", "Pink Floyd", "The Bealtles"};
Dictionary<string, List<int>> bandasRegistradas = new Dictionary<string, List<int>>();
bandasRegistradas.Add("Legião Urbana", new List<int> { 10, 9, 7 });
...
void ExibirMedia()
{
    ...
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        ...
        Console.WriteLine("Digite uma tecla para votar para o menu principal.");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
    }
